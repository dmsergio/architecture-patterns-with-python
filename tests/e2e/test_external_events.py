...
from random_refs import random_element
...
def test_change_batch_quantity_leading_to_reallocation():
    ...
    orderid, sku = random_element("order"), random_element("sku")
    earlier_batch, later_batch = random_element("old"), random_element("newer")
